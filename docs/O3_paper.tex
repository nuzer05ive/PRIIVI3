...
\usepackage{fontspec} % only works with XeLaTeX or LuaLaTeX
\setmainfont{Noto Sans} % or another font known to have the "☝️" glyph
\geometry{margin=1in}
